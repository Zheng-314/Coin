...
def visualize_accuracy(csv_file):
    ...
    # 添加图表标题和标签
    plt.title('train acc per class', fontsize=16)
    ...
    plt.tight_layout()
    plt.savefig('train_accuracy_trend.png', dpi=300, bbox_inches='tight')
    plt.show()
...
if __name__ == "__main__":
    csv_file = 'train_class_accuracies.csv'  # 替换为您的CSV文件路径
